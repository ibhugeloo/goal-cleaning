                    ...
                    {steps.map((step, index) => (
                        <AnimateInView key={index} delay={index * 300}>
                            <div className="flex flex-col items-center text-center p-6">
                                <div className="font-display text-7xl font-extrabold text-primary/20 leading-none mb-6">
                                    {step.number}
                                </div>
                                <h3 className="font-display text-2xl font-bold tracking-tight mb-3 text-foreground">{step.title}</h3>
